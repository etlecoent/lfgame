  ...
  return (
    ...
    {props.currentUser && 
      <DropdownButton
        ...
        title={"Menu"}
      >
        <Dropdown.Item className="menuItem" as={Link} to="/games">
            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-controller" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <Dropdown.Item className="menuItem" as={Link} to="/profile">
        ...
        <Dropdown.Item className="menuItem" as={Link} to="/update">
            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-file-earmark-person" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
